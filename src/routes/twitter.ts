...
export async function twitterRoutes(server: FastifyInstance) {
  ...
  server.post('/twitter/auto-responder/:username/start', {
    schema: {
  ...
  server.post('/twitter/auto-responder/:username/stop', {
    schema: {
  ...
  server.post('/twitter/topic-post/:username/start', {
    schema: {
  ...
  server.post('/twitter/topic-post/:username/stop', {
    schema: {
  ...
  server.post('/twitter/reply-mentions/:username/start', {
    schema: {
  ...
  server.post('/twitter/reply-mentions/:username/stop', {
    schema: {
  ...
  server.get('/twitter/status/:username', {
    schema: {
